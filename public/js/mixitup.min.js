        ...
        "undefined" == typeof n.nextElementSibling &&
            ...
            Array.prototype.indexOf ||
                (Array.prototype.indexOf = function(t) {
                    ...
                    if (
                        ((e = 0),
                        arguments.length > 1 && ((e = Number(arguments[1])), e !== e ? (e = 0) : 0 !== e && e !== 1 / 0 && e !== -(1 / 0) && (e = (e > 0 || -1) * Math.floor(Math.abs(e)))),
                        e >= i)
                    )
                        return -1;
        ...
        (n = {
            ...
            handleExtendError: function(t, n) {
                ...
                if (t instanceof TypeError && (i = a.exec(t.message))) {
                    ...
                    throw (u > 1 && (s = e.messages.errorConfigInvalidPropertySuggestion({ probableMatch: l })),
            ...
            isElement: function(e, n) {
                return (
                    ...
                    !!(t.HTMLElement && e instanceof t.HTMLElement) ||
                        !!(n.defaultView && n.defaultView.HTMLElement && e instanceof n.defaultView.HTMLElement) || (null !== e && 1 === e.nodeType && "string" == typeof e.nodeName)
                );
            },
        ...
        n.extend(e.Control.prototype, {
            ...
            update: function(t, n) {
                ...
                a.callActions("beforeUpdate", arguments),
                    ...
                    a.pending > 0 ||
                        ("live" === a.status ? a.updateLive(t, n) : ((i.sort = a.sort), (i.filter = a.filter), a.callFilters("actionsUpdate", i, arguments), a.parseStatusChange(a.el, t, i, n)),
        ...
        n.extend(e.Mixer.prototype, {
            ...
            attach: function(a, i, o, r) {
                ...
                for (
                    ...
                    l.hide();
                s.config.controls.enable && (s.initControls(), s.buildToggleArray(null, s.state), s.updateControls({ filter: s.state.activeFilter, sort: s.state.activeSort })),
                    s.parseEffects(),
            ...
            parseEffects: function() {
                ...
                for (n in e.transformDefaults)
                    e.transformDefaults[n] instanceof e.TransformData && (t.parseEffect(n, a, t.effectsIn, t.transformIn), t.parseEffect(n, i, t.effectsOut, t.transformOut, !0));
            ...
            cleanUp: function(t) {
                ...
                if (
                    ...
                    (a.dom.parent.style[e.features.transitionProp] = a.dom.parent.style.height = a.dom.parent.style.width = a.dom.parent.style.overflow = a.dom.parent.style[
            ...
            parseInsertArgs: function(t) {
                ...
                return (
                    !i.command.collection.length && a.config.debug.showWarnings && console.warn(e.messages.warningInsertNoElements()),
                    ...
                    a.config.animation.queue && a.queue.length < a.config.animation.queueLimit
                        ? ((t.deferred = i),
                          ...
                          a.config.controls.enable &&
                              (a.isToggling
                                  ? (a.buildToggleArray(t.instruction.command), (o = a.getToggleSelector()), a.updateControls({ filter: { selector: o } }))
            ...
            getDataOperation: function(t) {
                var a = this,
                    i = new e.Operation(),
                    o = [];
                if (((i = a.callFilters("operationUnmappedGetDataOperation", i, arguments)), a.dom.targets.length && !(o = a.state.activeDataset || []).length))
                    ...
                    (h[d] = !0),
                        (l = a.cache[d]) instanceof e.Target
                            ? (a.config.data.dirtyCheck &&
                                  ...
                                  (l.data = s),
                                  c !== l.dom.el &&
                                      (l.isInDom && (l.unbindEvents(), a.dom.parent.replaceChild(c, l.dom.el)), l.isShown || (c.style.display = "none"), (l.dom.el = c), l.isInDom && l.bindEvents())),
                              (c = l.dom.el))
                            : ((l = new e.Target()), l.init(null, a, s), l.hide()),
                        l.isInDom
                            ? ((f = l.dom.el.nextElementSibling),
                              o.push(d),
                              u && (u.lastElementChild && u.appendChild(a.dom.document.createTextNode(" ")), a.insertDatasetFrag(u, l.dom.el, r), (u = null)))
                    ...
                    t.isBusy
                        ...
                        : ((n = t.getOperation(o.command)),
                          t.config.controls.enable &&
                              (o.command.filter && !t.isToggling && ((t.toggleArray.length = 0), t.buildToggleArray(n.command)), t.queue.length < 1 && t.updateControls(n.command)),
                ...
                return (
                    ...
                    a.isBusy
                        ...
                        : (l && a.insertTargets(l, c),
                          ...
                          r
                              ? ((c.newContainerClassName = r.containerClassName), c.newContainerClassName !== c.startContainerClassName && (c.willChangeLayout = !0))
            ...
            forceRender: function() {
                ...
                for (a in t.cache)
                    (e = t.cache[a]),
                        (n = e.render(e.data)),
                        n !== e.dom.el &&
                            (e.isInDom && (e.unbindEvents(), t.dom.parent.replaceChild(n, e.dom.el)), e.isShown || (n.style.display = "none"), (e.dom.el = n), e.isInDom && e.bindEvents());
        ...
        n.extend(e.Target.prototype, {
            ...
            render: function(t) {
                var a = this,
                    ...
                    r = null,
                    s = "";
                if ((a.callActions("beforeRender", arguments), (i = a.callFilters("renderRender", a.mixer.config.render.target, arguments)), "function" != typeof i))
            ...
            writeTransitionRule: function(t, e, n) {
                var a = this,
                    ...
                    o = "";
                return (
                    (o = t + " " + (n > 0 ? n : a.mixer.config.animation.duration) + "ms " + i + "ms " + ("opacity" === t ? "linear" : a.mixer.config.animation.easing)),
